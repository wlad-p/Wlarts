...
public class GameActivity extends AppCompatActivity {
    ...
    public void displayValue(){
        ...
        {
            if(players.get(i) == Game.current_player)
                pos = i;
        }

        LinearLayout dashboard = findViewById(R.id.dashboard_placeholder);
        View player_dashboard = dashboard.getChildAt(pos);

        TextView score = player_dashboard.findViewById(R.id.player_score);
        score.setText(String.valueOf(Game.current_player.getPointsLeft()));
    }
}